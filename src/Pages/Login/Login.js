  ...
  return (
    <div style={{ marginTop: "125px" }} className="w-25 mx-auto bg-dark text-white p-5 rounded-2">
      ...
      <Form onSubmit={handleEmailLogin}>
        ...
        <Form.Group className="mb-3" controlId="formBasicPassword">
          ...
          <InputGroup className="mb-3">
            <Form.Control name="password" type="password" placeholder="Password" aria-label="Username" aria-describedby="basic-addon1" />
      ...
      <Button variant="light" type="submit" onClick={handleGoogleLogin} className="w-100">
        <FaGoogle />
        <span className="ms-1 fw-bold">Login with Google</span>
      </Button>
    </div>
  );
};
